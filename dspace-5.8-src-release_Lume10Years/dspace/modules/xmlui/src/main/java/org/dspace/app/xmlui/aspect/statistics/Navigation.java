...
public class Navigation extends AbstractDSpaceTransformer implements CacheableProcessingComponent {
    ...
    public void addOptions(Options options) throws SAXException, WingException, UIException, SQLException, IOException, AuthorizeException
    {
		...
		statistics.addItemXref(contextPath + "/handle/" + dso.getHandle() + "/stats", message("xmlui.Statistics.LumeStatisticsUso"));
            }
	    ...
	    statistics.addItemXref(contextPath + "/handle/" + dso.getHandle() + "/stats/topten", message("xmlui.menu.statistics.toptem"));
	    statistics.addItemXref(contextPath + "/handle/" + dso.getHandle() + "/stats/downloads", message("xmlui.menu.statistics.download"));
        }
